...
const LeavesList = () => {
  ...
  useEffect(() => {
    const fetchLeaves = async () => {
      try {
        const response = await axios.get(`http://localhost:3000/api/leaves/user/${user._id}`, {
  ...
  return (
    <div className="relative rounded-lg  bg-indigo-600 mt-6 overflow-hidden"> 
      ...
      <div className="z-10 flex flex-col items-center ">
        <span className="font-semibold text-xl text-white mb-4 py-4">Manage Leaves</span> 
