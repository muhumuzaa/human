    ...
    <div className="border-b border-gray-200 py-2 grid grid-cols-10 items-center gap-4 w-full ">
      <div className="col-span-3 space-x-4 flex">
        ...
        <div className="flex flex-col">
          <span
            className="block text-gray-700 font-semibold cursor-pointer hover:text-indigo-500"
      ...
      <div className=" space-x-2 flex justify-between">
        <button
          className="text-xs border border-gray-500 bg-gray-200 rounded-lg px-2 py-1 hover:bg-gray-200"
          onClick={() => editEmployee(employee)}
        >
          Edit
        </button>
        <button
          className="text-xs border border-green-500 rounded-lg px-2 py-1  hover:bg-green-400"
          onClick={() => onViewSalary(employee)}
        >
          Salary
        </button>
        <button
          className="text-xs border bg-red-100 border-red-500 rounded-lg px-2 py-1 hover:bg-red-400"
        ...
        >
          ...
          <button
            className="text-xs border border-red-500 rounded-lg px-2 py-1 hover:bg-gray-200"
