const EmployeeCard = ({employee, editEmployee, deleteEmployee, viewDetails}) => {
  return (
...
/>
      ...
      <div className="col-span-2 space-x-2 flex justify-between">
        ...
        <button className="text-xs border border-green-500 rounded-lg px-2 py-1 hover:bg-gray-200" onClick={() =>editEmployee(employee)}>Salary</button>
